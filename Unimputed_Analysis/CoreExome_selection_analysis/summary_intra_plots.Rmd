...
urate_goutGR <- gwas_genes_ucscGR[gwas_genes_ucscGR$SYMBOL %in% unique(unlist(strsplit(gwas_interested[grep("gout|urate",gwas_interested$DISEASE.TRAIT, ignore.case = TRUE),]$REPORTED.GENE.S., ', '))),]
...
## nzcau
```{r}
as.data.frame(GenomicRanges::subsetByOverlaps(nzcau_fawGR, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps( obesity_GR,nzcau_fawGR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(nzcau_tdGR, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,nzcau_tdGR ),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(cau_ihs_regions, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,cau_ihs_regions),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(cau_nsl_regions, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,cau_nsl_regions),row.names = NULL)
table(obesity_GR$SYMBOL %in% t(as.data.frame(nzcau[['kaks']]  %>% filter(ka/ks > 2)  %>% dplyr::select(GeneName))) )
```

## nzm
```{r}
as.data.frame(GenomicRanges::subsetByOverlaps(nzm_fawGR, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps( obesity_GR,nzm_fawGR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(nzm_tdGR, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,nzm_tdGR ),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(nzm_ihs_regions, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,nzm_ihs_regions),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(nzm_nsl_regions, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,nzm_nsl_regions),row.names = NULL)
table(obesity_GR$SYMBOL %in% t(as.data.frame(nzm[['kaks']]  %>% filter(ka/ks > 2)  %>% dplyr::select(GeneName))) )
```

## cim
```{r}
as.data.frame(GenomicRanges::subsetByOverlaps(cim_fawGR, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps( obesity_GR,cim_fawGR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(cim_tdGR, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,cim_tdGR ),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(cim_ihs_regions, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,cim_ihs_regions),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(cim_nsl_regions, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,cim_nsl_regions),row.names = NULL)
table(obesity_GR$SYMBOL %in% t(as.data.frame(cim[['kaks']]  %>% filter(ka/ks > 2)  %>% dplyr::select(GeneName))) )
```

## ton
```{r}
as.data.frame(GenomicRanges::subsetByOverlaps(ton_fawGR, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps( obesity_GR,ton_fawGR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(ton_tdGR, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,ton_tdGR ),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(ton_ihs_regions, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,ton_ihs_regions),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(ton_nsl_regions, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,ton_nsl_regions),row.names = NULL)
table(obesity_GR$SYMBOL %in% t(as.data.frame(ton[['kaks']]  %>% filter(ka/ks > 2)  %>% dplyr::select(GeneName))) )
```

## sam
```{r}
as.data.frame(GenomicRanges::subsetByOverlaps(sam_fawGR, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps( obesity_GR,sam_fawGR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(sam_tdGR, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,sam_tdGR ),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(sam_ihs_regions, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,sam_ihs_regions),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(sam_nsl_regions, obesity_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(obesity_GR,sam_nsl_regions),row.names = NULL)
table(obesity_GR$SYMBOL %in% t(as.data.frame(sam[['kaks']]  %>% filter(ka/ks > 2)  %>% dplyr::select(GeneName))) )
```

# Diabetes
## nzcau
```{r}
as.data.frame(GenomicRanges::subsetByOverlaps(nzcau_fawGR, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps( diabetes_GR,nzcau_fawGR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(nzcau_tdGR, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,nzcau_tdGR ),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(cau_ihs_regions, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,cau_ihs_regions),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(cau_nsl_regions, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,cau_nsl_regions),row.names = NULL)
table(diabetes_GR$SYMBOL %in% t(as.data.frame(nzcau[['kaks']]  %>% filter(ka/ks > 2)  %>% dplyr::select(GeneName))) )
```

## nzm
```{r}
as.data.frame(GenomicRanges::subsetByOverlaps(nzm_fawGR, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps( diabetes_GR,nzm_fawGR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(nzm_tdGR, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,nzm_tdGR ),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(nzm_ihs_regions, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,nzm_ihs_regions),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(nzm_nsl_regions, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,nzm_nsl_regions),row.names = NULL)
table(diabetes_GR$SYMBOL %in% t(as.data.frame(nzm[['kaks']]  %>% filter(ka/ks > 2)  %>% dplyr::select(GeneName))) )
```

## cim
```{r}
as.data.frame(GenomicRanges::subsetByOverlaps(cim_fawGR, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps( diabetes_GR,cim_fawGR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(cim_tdGR, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,cim_tdGR ),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(cim_ihs_regions, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,cim_ihs_regions),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(cim_nsl_regions, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,cim_nsl_regions),row.names = NULL)
table(diabetes_GR$SYMBOL %in% t(as.data.frame(cim[['kaks']]  %>% filter(ka/ks > 2)  %>% dplyr::select(GeneName))) )
```

## ton
```{r}
as.data.frame(GenomicRanges::subsetByOverlaps(ton_fawGR, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps( diabetes_GR,ton_fawGR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(ton_tdGR, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,ton_tdGR ),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(ton_ihs_regions, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,ton_ihs_regions),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(ton_nsl_regions, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,ton_nsl_regions),row.names = NULL)
table(diabetes_GR$SYMBOL %in% t(as.data.frame(ton[['kaks']]  %>% filter(ka/ks > 2)  %>% dplyr::select(GeneName))) )
```

## sam
```{r}
as.data.frame(GenomicRanges::subsetByOverlaps(sam_fawGR, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps( diabetes_GR,sam_fawGR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(sam_tdGR, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,sam_tdGR ),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(sam_ihs_regions, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,sam_ihs_regions),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(sam_nsl_regions, diabetes_GR),row.names = NULL)
as.data.frame(GenomicRanges::subsetByOverlaps(diabetes_GR,sam_nsl_regions),row.names = NULL)
table(diabetes_GR$SYMBOL %in% t(as.data.frame(sam[['kaks']]  %>% filter(ka/ks > 2)  %>% dplyr::select(GeneName))) )
```
